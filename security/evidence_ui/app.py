...
# Serve static files for the embedded evidence UI
UI_DIR = Path(__file__).resolve().parent
app.mount("/frontend", StaticFiles(directory=UI_DIR), name="frontend")
...
SCAN_MEM: deque[dict[str, Any]] = deque(maxlen=50)
        ...
        out.append(
            {
                ...
                "evidence_types": list(getattr(meta, "evidence_types", []) or []) if meta else [],
            }
        )
    return out
