		...
		<div className={pageClasses} style={pageStyle}>
			<div className="mx-auto max-w-250">
				<div className="mb-6 flex flex-wrap items-center justify-between gap-3">
					...
					<button
						type="button"
						className={`inline-flex items-center gap-2 rounded-lg border px-4 py-2 text-sm font-medium transition-colors ${borderColor} ${textSecondary} disabled:cursor-not-allowed disabled:opacity-60`}
						onClick={() => {
