...
# 30 or fewer days is compliant; more than 30 days, or expiration
# disabled entirely, is not.
...
generate_message(true) := "Guest access to SharePoint sites and OneDrive is set to expire automatically within 30 days"

generate_message(false) := "Guest access to SharePoint sites and OneDrive is not set to expire within 30 days (expiration is disabled or set to more than 30 days)"